...
declare class MuxPlayerElement extends VideoApiElement implements MuxPlayerElement {
    ...
    get mux(): Readonly<MuxOnVideoElement | DeletedMuxOnVideoElement | undefined>;
    /**
     * Gets the theme.
     */
    get theme(): string;
    ...
    get widgets(): string | undefined;
    set widgets(val: string | undefined);
    ...
    get maxResolution(): string | undefined;
