...
import { ValueOf, Metadata, StreamTypes, PlaybackTypes, PlaybackEngine, CmcdTypes } from "@mux/playback-core";
...
interface MuxPlayerElement extends Pick<HTMLVideoElement, Exclude<keyof HTMLVideoElement, "poster" | "textTracks" | "addTextTrack" | "src">> {
...
declare class MuxPlayerElement extends VideoApiElement implements MuxPlayerElement {
    ...
    readonly mux: Readonly<MuxOnVideoElement | DeletedMuxOnVideoElement | undefined>;
    /*
    * Gets the theme.
